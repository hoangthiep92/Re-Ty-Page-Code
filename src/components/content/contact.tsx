            ...
            <div className="arlo_tm_section" id="contact">
                ...
                <div className="arlo_tm_footer_contact_wrapper_all">
                            ...
                            <div className="leftbox">
                                ...
                                <div className="short_info_wrap">
                                    <ul>
                                        ...
                                        <li><p><label>Email:</label><span><a href="mailto:sunshou.duythiep@gmail.com">sunshou.duythiep@gmail.com</a></span></p></li>
                                        <li><p><label>Phone:</label><span>+81 xxx xxx xxx</span></p></li>
                                        <li><p><label>Website:</label>
                                            <span>
                                                <a
                                                    href="mailto:example@gmail.com"
                                                    target="_blank"
                                                >www.yourdomain.com</a></span></p></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="arlo_tm_footer_wrap">
                        <div className="container">
                            <p>&copy; Copyright 2023. By Hoang Duy Thiep.</p>
                        </div>
                    </div>
                </div>
            </div>
