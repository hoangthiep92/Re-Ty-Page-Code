                            ...
                            <div className="author_wrap">
                                ...
                                <div className="rightbox">
                                    ...
                                    <div className="definition">
                                        <p>Hi! My name is <strong>Hoang Duy Thiep</strong>. I am a Web Developer, and I'm very passionate and dedicated to my work. With 20 years experience as a professional Web developer, I have acquired the skills and knowledge necessary to make your project a success. I enjoy every step of the design process, from discussion and collaboration to concept and execution, but I find the most satisfaction in seeing the finished product do everything for you that it was created to do.</p>
                                    </div>
                                    <div className="about_short_contact_wrap">
                                        <ul>
                                            <li>
                                                <span><label>Birthday:</label> 01.08.1992</span>
                                            </li>
                                            <li>
                                                <span><label>Age:</label> 18</span>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <span><label>Study:</label>University</span>
                                            </li>
                                            <li>
                                                <span><label>Degree:</label> Newbie</span>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <span><label>Phone:</label> <a href="#">+xx xxx xxx xxx</a></span>
                                            </li>
                                            <li>
